    ...
    <div class="container">
        ...
        <div class="hero__image">
            <picture>
                ...
                <img src="<?= get_template_directory_uri(); ?>/assets/images/capa.png" alt="<?= SITE["name"]; ?> - Capa"
                    loading="lazy">
            </picture>
        </div>
        <!-- end of image -->
    ...
    <div class="container">
        ...
        <div class="services__grid">
            ...
            <article class="services__grid__card">
                ...
                <div class="services__grid__card__image">
                    <picture>
                        <source srcset="<?= get_template_directory_uri(); ?>/assets/images/servico-banho-e-tosa.webp"
                            type="image/webp">
    ...
    <div class="container">
        ...
        <div class="testimonial__carousel owl-carousel">
            ...
            <div class="testimonial__carousel__item">
                ...
                <picture>
                    <source srcset="<?= get_template_directory_uri(); ?>/assets/images/<?= $testimony["image"]; ?>.webp"
                        type="image/webp">
