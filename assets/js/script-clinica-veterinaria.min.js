...
return jQuery});$(function(){$(window).scroll(function(){if($(window).scrollTop()){$('header.header').addClass('p-fixed')}else{$('header.header').removeClass('p-fixed')}})});$(function(){$('.header__navbar__section__toggle').click(function(){var clicks=$(this).data('clicks');if(clicks){$('body').css('overflow','auto')}else{$('body').css('overflow','hidden')}
$(this).data("clicks",!clicks);$('.header').toggleClass('header--active')})});(function(global,factory){typeof exports==='object'&&typeof module!=='undefined'?factory(exports):typeof define==='function'&&define.amd?define(['exports'],factory):(global=global||self,factory(global.window=global.window||{}))}(this,(function(exports){'use strict';function _inheritsLoose(subClass,superClass){subClass.prototype=Object.create(superClass.prototype);subClass.prototype.constructor=subClass;subClass.__proto__=superClass}
...
config.trigger=target;result.push(ScrollTrigger.create(config))});return result};ScrollTrigger.sort=function(func){return _triggers.sort(func||function(a,b){return(a.vars.refreshPriority||0)*-1e6+a.start-(b.start+(b.vars.refreshPriority||0)*-1e6)})};_getGSAP()&&gsap.registerPlugin(ScrollTrigger);exports.ScrollTrigger=ScrollTrigger;exports.default=ScrollTrigger;Object.defineProperty(exports,'__esModule',{value:!0})})));let footer=gsap.timeline({scrollTrigger:{trigger:'.footer',start:'left bottom'}});gsap.from('.header',{opacity:0,duration:1.5,delay:.5,y:-50,ease:'Back.easeInOut'});gsap.from('.whatsapp',{opacity:0,duration:1.5,delay:1.5,x:0,ease:'Back.easeInOut'});footer.from('.footer',{opacity:0,duration:1.5,y:100,ease:'SlowMo.easeInOut',});let ctaPages=gsap.timeline({scrollTrigger:{trigger:'.cta__pages',start:'center bottom'}});gsap.from('.pages__header',{opacity:0,duration:1.5,y:-50,ease:'Elastic.easeInOut'});ctaPages.from('.cta__row',{opacity:0,duration:1.5,y:150,ease:'Back.easeInOut'});let clinic=gsap.timeline({scrollTrigger:{trigger:'.clinic',start:'top top',end:"+=500"}});let specialties=gsap.timeline({scrollTrigger:{trigger:'.clinic__specialties',start:'left bottom',}});clinic.from('.clinic__about__row__body',{opacity:0,duration:1.5,x:-150,ease:'Back.easeInOut'}).from('.clinic__about__row__image',{opacity:0,duration:1.5,y:150,ease:'Back.easeInOut'},'-=.7');specialties.from('.clinic__specialties__grid__card:nth-child(1)',{opacity:0,duration:1.25,y:50,ease:'Elastic.easeInOut'}).from('.clinic__specialties__grid__card:nth-child(2)',{opacity:0,duration:1.25,y:50,ease:'Elastic.easeInOut'}).from('.clinic__specialties__grid__card:nth-child(3)',{opacity:0,duration:1.25,y:50,ease:'Elastic.easeInOut'}).from('.clinic__specialties__grid__card:nth-child(4)',{opacity:0,duration:1.25,y:50,ease:'Elastic.easeInOut'}).from('.clinic__specialties__grid__card:nth-child(5)',{opacity:0,duration:1.25,y:50,ease:'Elastic.easeInOut'}).from('.clinic__specialties__grid__card:nth-child(6)',{opacity:0,duration:1.25,y:50,ease:'Elastic.easeInOut'}).from('.clinic__specialties__grid__card:nth-child(7)',{opacity:0,duration:1.25,y:50,ease:'Elastic.easeInOut'}).from('.clinic__specialties__grid__card:nth-child(8)',{opacity:0,duration:1.25,y:50,ease:'Elastic.easeInOut'}).from('.clinic__specialties__grid__card:nth-child(9)',{opacity:0,duration:1.25,y:50,ease:'Elastic.easeInOut'}).from('.clinic__specialties__grid__card:nth-child(10)',{opacity:0,duration:1.25,y:50,ease:'Elastic.easeInOut'})