...
config.trigger=target;result.push(ScrollTrigger.create(config))});return result};ScrollTrigger.sort=function(func){return _triggers.sort(func||function(a,b){return(a.vars.refreshPriority||0)*-1e6+a.start-(b.start+(b.vars.refreshPriority||0)*-1e6)})};_getGSAP()&&gsap.registerPlugin(ScrollTrigger);exports.ScrollTrigger=ScrollTrigger;exports.default=ScrollTrigger;Object.defineProperty(exports,'__esModule',{value:!0})})));let footer=gsap.timeline({scrollTrigger:{trigger:'.footer',start:'left bottom'}});gsap.from('.header',{opacity:0,duration:1.5,delay:.5,y:-50,ease:'Back.easeInOut'});gsap.from('.whatsapp',{opacity:0,duration:1.5,delay:1.5,x:0,ease:'Back.easeInOut'});footer.from('.footer',{opacity:0,duration:1.5,y:100,ease:'SlowMo.easeInOut',});let ctaPages=gsap.timeline({scrollTrigger:{trigger:'.cta__pages',start:'center bottom'}});gsap.from('.pages__header',{opacity:0,duration:1.5,y:-50,ease:'Elastic.easeInOut'});ctaPages.from('.cta__row',{opacity:0,duration:1.5,y:150,ease:'Back.easeInOut'});let expedient=gsap.timeline({scrollTrigger:{trigger:'.contact__expedient',start:'left center',end:'+=100'}});let phones=gsap.timeline({scrollTrigger:{trigger:'.contact__phones',start:'left bottom'}});let mail=gsap.timeline({scrollTrigger:{trigger:'.contact__mail',start:'left bottom'}});let address=gsap.timeline({scrollTrigger:{trigger:'.contact__address',start:'left bottom'}});let map=gsap.timeline({scrollTrigger:{trigger:'.map',start:'left bottom'}});expedient.from(['.contact__expedient__header','.contact__expedient__content'],{opacity:0,duration:1.5,y:150,ease:'Back.easeInOut'});phones.from('.contact__phones',{opacity:0,duration:1.5,y:150,ease:'Back.easeInOut'});mail.from('.contact__mail',{opacity:0,duration:1.5,y:150,ease:'Back.easeInOut'});address.from('.contact__address',{opacity:0,duration:1.5,y:150,ease:'Back.easeInOut'});map.from('.map',{opacity:0,duration:1.5,ease:'Back.easeInOut'})