...
config.trigger=target;result.push(ScrollTrigger.create(config))});return result};ScrollTrigger.sort=function(func){return _triggers.sort(func||function(a,b){return(a.vars.refreshPriority||0)*-1e6+a.start-(b.start+(b.vars.refreshPriority||0)*-1e6)})};_getGSAP()&&gsap.registerPlugin(ScrollTrigger);exports.ScrollTrigger=ScrollTrigger;exports.default=ScrollTrigger;Object.defineProperty(exports,'__esModule',{value:!0})})));let footer=gsap.timeline({scrollTrigger:{trigger:'.footer',start:'left bottom'}});gsap.from('.header',{opacity:0,duration:1.5,delay:.5,y:-50,ease:'Back.easeInOut'});gsap.from('.whatsapp',{opacity:0,duration:1.5,delay:1.5,x:0,ease:'Back.easeInOut'});footer.from('.footer',{opacity:0,duration:1.5,y:100,ease:'SlowMo.easeInOut',});let ctaPages=gsap.timeline({scrollTrigger:{trigger:'.cta__pages',start:'center bottom'}});gsap.from('.pages__header',{opacity:0,duration:1.5,y:-50,ease:'Elastic.easeInOut'});ctaPages.from('.cta__row',{opacity:0,duration:1.5,y:150,ease:'Back.easeInOut'});let bath=gsap.timeline({scrollTrigger:{trigger:'.bath',start:'center bottom'}});let gallery=gsap.timeline({scrollTrigger:{trigger:'.gallery',start:'center bottom'}});let taxi=gsap.timeline({scrollTrigger:{trigger:'.taxi',start:'center bottom'}});bath.from('.bath__center__row__body',{opacity:0,duration:1.5,x:-150,ease:'Back.easeInOut'}).from('.bath__center__row__image',{opacity:0,duration:1.5,y:150,ease:'Back.easeInOut'},'-=.7').from('.bath__bath__row__image',{opacity:0,duration:1.5,x:-150,ease:'Back.easeInOut'}).from('.bath__bath__row__body',{opacity:0,duration:1.5,y:-150,ease:'Back.easeInOut'},'-=.7');gallery.from('.gallery',{opacity:0,duration:1.5,ease:'Power1.easeInOut'});taxi.from('.taxi__row__content',{opacity:0,duration:1.5,x:-150,ease:'Back.easeInOut'}).from('.taxi__row__image',{opacity:0,duration:1.25,y:150,ease:'Bouce.easeInOut'})